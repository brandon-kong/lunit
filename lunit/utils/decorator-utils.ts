import { Annotation, DecoratorOptions, MethodDecorator } from "../common";
import { addTest, addAnnotations, addClassMetadata } from "./metadata";

export function createDecorator<T extends object>({ annotation, options = {} }: DecoratorOptions): MethodDecorator<T> {
